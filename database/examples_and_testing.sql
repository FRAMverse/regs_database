...
with fish as (
    insert into fishery_regulation (fishery_id, fishery_regulation_type_id,
        ...
        values ('dc820f06-8451-4830-b9c0-6e59574323d7', 'd1aa8518-ffcf-4e70-a7b9-32874f916681',
...
join species_group sg on bl.species_group_type_id = sg.species_group_type_id
join species_lut sl2 on sg.species_id = sl2.species_id
...
where
    sl2.species_name = 'Chinook salmon'
...
select start_datetime, created_datetime from fishery_regulation
